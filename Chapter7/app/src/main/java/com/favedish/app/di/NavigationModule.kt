...
import com.favedish.app.navigation.AppNewDishDestinationToUiMapper
...
class NavigationModule {
    ...
    @Provides
    fun providesNewDishDestinationToUiMapper(
        fragmentManager: FragmentManager,
        globalDestinationToUiMapper: GlobalDestinationToUiMapper
    ): NewDishDestinationToUiMapper =
        AppNewDishDestinationToUiMapper(fragmentManager, globalDestinationToUiMapper)
}
